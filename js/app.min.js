...
let bearClick = document.querySelector('.start__img');
let imgBear = document.querySelector('.img-anim');
let bearText = document.querySelector('.start-var');
// console.log(bears);
...
bearClick.addEventListener('click', function () {
	header.classList.add('_trs')

	for (let i = 0; i < words.length; i++) {
		const word = words[i];
		// console.log(wordsNum, i);

		if (i == wordsNum) {
			bearText.innerHTML = word;
		}
	}
	wordsNum++;
	...
	for (let i = 0; i < colors.length; i++) {
		const curent = colors[i];
		if (i == num) {
			body.style.setProperty('--color', curent);
		}
	}
	num++;
...
//========================================================================================================================================================
let changeImg = document.querySelector('.build-image-change');

let changeNum = 0;

function changeBears() {
	for (let i = 0; i < bears.length; i++) {
		const bearCurent = bears[i];
		if (i == changeNum) {
			changeImg.src = bearCurent;
		}
	}
	changeNum++;
	if (changeNum == bears.length) {
		changeNum = 0;
	}
}

setInterval(changeBears, 200)
